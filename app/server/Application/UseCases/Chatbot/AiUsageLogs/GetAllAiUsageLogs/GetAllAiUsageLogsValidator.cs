...
public class GetAllAiUsageLogsValidator : AbstractValidator<GetAllAiUsageLogsRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public GetAllAiUsageLogsValidator(IErrorMessageService errorMessageService)
    {
