...
public class GetAllChatbotKnowledgeBasesValidator : AbstractValidator<GetAllChatbotKnowledgeBasesRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public GetAllChatbotKnowledgeBasesValidator(IErrorMessageService errorMessageService)
    {
