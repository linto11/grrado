...
public class GetAllChatbotConversationsValidator : AbstractValidator<GetAllChatbotConversationsRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public GetAllChatbotConversationsValidator(IErrorMessageService errorMessageService)
    {
