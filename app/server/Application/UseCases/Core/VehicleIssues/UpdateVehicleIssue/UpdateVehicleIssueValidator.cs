...
public class UpdateVehicleIssueValidator : AbstractValidator<UpdateVehicleIssueRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public UpdateVehicleIssueValidator(IErrorMessageService errorMessageService)
    {
