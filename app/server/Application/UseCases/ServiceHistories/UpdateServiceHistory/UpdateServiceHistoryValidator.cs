...
public class UpdateServiceHistoryValidator : AbstractValidator<UpdateServiceHistoryRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public UpdateServiceHistoryValidator(IErrorMessageService errorMessageService)
    {
