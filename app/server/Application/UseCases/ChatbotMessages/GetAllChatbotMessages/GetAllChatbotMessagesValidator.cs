...
public class GetAllChatbotMessagesValidator : AbstractValidator<GetAllChatbotMessagesRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public GetAllChatbotMessagesValidator(IErrorMessageService errorMessageService)
    {
