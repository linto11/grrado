...
public class GetAllDiagnosticRulesValidator : AbstractValidator<GetAllDiagnosticRulesRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public GetAllDiagnosticRulesValidator(IErrorMessageService errorMessageService)
    {
