...
public class GetAllVehicleIssuesValidator : AbstractValidator<GetAllVehicleIssuesRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public GetAllVehicleIssuesValidator(IErrorMessageService errorMessageService)
    {
