...
namespace Application.UseCases.Chatbot.AiImageAnalyses.GetAllAiImageAnalyses;

public class GetAllAiImageAnalysesValidator : AbstractValidator<GetAllAiImageAnalysesRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public GetAllAiImageAnalysesValidator(IErrorMessageService errorMessageService)
    {
