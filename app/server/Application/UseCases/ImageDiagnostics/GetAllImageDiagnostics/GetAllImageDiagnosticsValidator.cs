...
public class GetAllImageDiagnosticsValidator : AbstractValidator<GetAllImageDiagnosticsRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public GetAllImageDiagnosticsValidator(IErrorMessageService errorMessageService)
    {
