...
namespace Application.UseCases.Core.Garages.GetAllGarages;

public class GetAllGaragesValidator : AbstractValidator<GetAllGaragesRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public GetAllGaragesValidator(IErrorMessageService errorMessageService)
    {
