...
public class UnitOfWork : IUnitOfWork
{
    ...
    private IRepository<ChatbotConversation>? _chatbotConversationRepository;
    private IRepository<ChatbotMessage>? _chatbotMessageRepository;
    private IRepository<ChatbotKnowledgeBase>? _chatbotKnowledgeBaseRepository;
    ...
    public IRepository<ChatbotConversation> ChatbotConversations => _chatbotConversationRepository ??= new BaseRepository<ChatbotConversation>(_context);
    public IRepository<ChatbotMessage> ChatbotMessages => _chatbotMessageRepository ??= new BaseRepository<ChatbotMessage>(_context);
    public IRepository<ChatbotKnowledgeBase> ChatbotKnowledgeBases => _chatbotKnowledgeBaseRepository ??= new BaseRepository<ChatbotKnowledgeBase>(_context);
    public IRepository<AiImageAnalysis> AiImageAnalyses => _aiImageAnalysisRepository ??= new BaseRepository<AiImageAnalysis>(_context);
