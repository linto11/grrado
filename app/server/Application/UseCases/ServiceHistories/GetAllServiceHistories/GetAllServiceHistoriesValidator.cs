...
namespace Application.UseCases.ServiceHistories.GetAllServiceHistories;

public class GetAllServiceHistoriesValidator : AbstractValidator<GetAllServiceHistoriesRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public GetAllServiceHistoriesValidator(IErrorMessageService errorMessageService)
    {
