...
public class DeleteChatbotConversationValidator : AbstractValidator<DeleteChatbotConversationRequest>
{
    private readonly IErrorMessageService _errorMessageService;

    public DeleteChatbotConversationValidator(IErrorMessageService errorMessageService)
    {
